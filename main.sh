...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Jpstore1/vip/main/izin-ip-sandz | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Jpstore1/vip/main/izin-ip-sandz | grep $ipsaya | awk '{print $3}')
