...
apt upgrade -y 
apt update -y 
apt install curl -y # Fix: curls -> curl 
...
data_ip="https://raw.githubusercontent.com/Jpstore1/ip/main/ip" # Diubah 
checking_sc() { 
  ...
  if [[ $date_list < $useexp ]]; then 
    ...
    echo -e "\033[42m                    404 NOT FOUND JP_OFFICIAL_STORE                    \033[0m" # Diubah 
    echo -e "\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" 
    echo -e "" 
    echo -e "            ${RED}PERMISSION DENIED !${NC}" 
    echo -e "   \033[0;33mYour VPS${NC} $ipsaya \033[0;33mHas been Banned${NC}" 
    echo -e "     \033[0;33mBuy access permissions for JP_OFFICIAL_STORE${NC}" # Diubah 
    echo -e "             \033[0;33mContact Admin :${NC}" 
    echo -e "      \033[0;36mTelegram${NC} t.me/JPOFFICIALSTORE" # Diubah 
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/087873951705" # Diubah 
    echo -e "\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" 
    exit 
  fi 
} 
...
clear;clear;clear 
echo -e "${BlueBee}═╦═══════════════════════════════════════════════════════════════════════╩═${NC}" 
echo -e "\033[96;1m                       JP_OFFICIAL_STORE               \033[0m" # Diubah 
echo -e "${BlueBee}╩═╩═══════════════════════════════════════════════════════════════════════╦═${NC}" 
echo "" 
echo "" 
...
url_izin="https://raw.githubusercontent.com/Jpstore1/ip/main/ip" # Diubah 
rm -f /usr/bin/user 
...
clear 
REPO="https://raw.githubusercontent.com/Jpstore1/vip/main/" # Diubah 
start=$(date +%s) 
secs_to_human() { 
...
TIMES="10" 
CHATID="6807547477" # Ini masih ada, jika ingin dihapus perlu instruksi eksplisit 
KEY="7123588087:AAF4QmZq_fbbEUMqztAO-FlczjbOGQhfQQ0" # Ini masih ada, jika ingin dihapus perlu instruksi eksplisit 
...
TEXT=" 
<code>━━━━━━━━━━━━━━━━━━━━━━━━━━</code> 
<b> ⚡ JP_OFFICIAL_STORE AUTO SCRIPT PREMIUM ⚡</b> 
<code>━━━━━━━━━━━━━━━━━━━━━━━━━━</code> 
...
<code>━━━━━━━━━━━━━━━━━━━━━━━━━━</code> 
<i>Notif Install JP_OFFICIAL_STORE</i> 
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/JPOFFICIALSTORE"},{"text":"Contact","url":"wa.me/087873951705"}]]}' # Diubah 
...
debconf-set-selections <<<"keyboard-confi
